-- Phase 08: org-scoped business listing with filters, sort and pagination.
-- security invoker: RLS still applies; the explicit is_org_member(org_id) guard
-- keeps results scoped even for users belonging to multiple organizations.
