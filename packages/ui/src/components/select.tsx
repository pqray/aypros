...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex h-9 w-full items-center justify-between whitespace-nowrap rounded-md border border-input bg-card px-3 py-2 text-sm shadow-sm placeholder:text-muted-foreground focus:outline-none focus-visible:ring-2 focus-visible:ring-ring disabled:cursor-not-allowed disabled:opacity-50 [&>span]:line-clamp-1",
      className,
    )}
    {...props}
  >
    ...
    <SelectPrimitive.Icon asChild>
      <PiCaretDown className="size-4 opacity-50" aria-hidden />
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.ScrollUpButton
    ...
    {...props}
  >
    <PiCaretUp className="size-4" aria-hidden />
  </SelectPrimitive.ScrollUpButton>
));
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.ScrollDownButton
    ...
    {...props}
  >
    <PiCaretDown className="size-4" aria-hidden />
  </SelectPrimitive.ScrollDownButton>
));
  ...
  >
    <span className="absolute right-2 flex size-3.5 items-center justify-center">
      <SelectPrimitive.ItemIndicator>
        <PiCheck className="size-4" aria-hidden />
      </SelectPrimitive.ItemIndicator>
    </span>
